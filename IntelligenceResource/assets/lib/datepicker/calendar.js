(function () {
    var CalendarObj = function(){
        ...
        self.setSelectDay = function(date){
            ...
            day = date.getDate();
            week = date.getDay();
            $('#calendar_head_date').html(t+"年"+n+"月"+day+"日");
        ...
        self.onDragUp = function(){
            ...
            var allRows = $("#calendar_content .row");
        ...
        function drawWeekHead() {
            ...
            for (var e = 0; e < 7; e++) {
                $("#calendar_weekdays").append("<div class='col'>" + s[e].substring(0, 3) + "</div>");
            }
        }
