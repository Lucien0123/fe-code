...
angular.module('myweb.controllers').controller('MoreAssessController', ['$scope', '$location', '$rootScope', 'GlobalStorageService', MoreAssessControllerCtrl]);

function MoreAssessControllerCtrl($scope, $location, $rootScope, GlobalStorageService) {
    //将变量定义在self中，仅能被本controller和对应的页面访问到
    var self = this;
    console.log("this is MoreAssessController")
}